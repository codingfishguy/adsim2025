...
To work out the SIR approximation of $E[X_n|y_{0:T}]$ I used the paths that I previously calculated to illustrate path degeneracy and calculated their mean. @fig-31 displays the true value of the hidden state at each time n, alongside both particle approximations of $

```{r}
#| echo: False
#| label: fig-31
#| fig-cap: "Filter vs Smoothing Estimates N=50"
#| fig-width: 12
#| fig-height: 4
...
EX_smooth_ffbsm <- smooth_mean(SIR50$samples, ffbsm_weights1)
...
```{r}
#| echo: False
#| fig-cap: "n=500 Smoothing Estimates"
#| fig-width: 12
#| fig-height: 4
...
EX_smooth <- colMeans(paths500)
plot(1:201, EX_smooth, type="l", lwd=2,
     xlab="Time", ylab="E[X_n | y_{0:T}]")
...
```{r}
#| echo: False
#| fig-cap: "n=50 Filter Estimates"
#| fig-width: 12
#| fig-height: 4

EX_filter <- colMeans(SIR500$samples)
plot(1:201, EX_filter, type="l", lwd=2,
     xlab="Time", ylab="E[X_n | y_{0:n}]")
