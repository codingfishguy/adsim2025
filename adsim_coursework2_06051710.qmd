...
### Sampling from the SIR particle filter
...
### Sampling using a particle smoothing algorithm

For this question I chose to use...
...
The SIR filter has clear path degeneracy. Though this is harder to make out from the plot of the paths of all particles in @fig-3, plotting the paths from n=190 onwards and comparing this to the paths from n=0 to 20 makes it evident. In fact there is only a single path when going back from n=154.


```{r}
#| echo: False
#| label: fig-3
#| fig-cap: "Path Degeneracy Plots"
#| fig-width: 10
#| fig-height: 4
...
matplot(t(paths50), type = "l", lty = 1, col = rgb(0, 0, 0, 0.1),
...
#| echo: False
#| label: fig-4
#| fig-cap: "Visualising the start and end of the paths"
#| fig-width: 12
#| fig-height: 4
par(mfrow=c(1,2))
...
```{r}
#| echo: False
#| fig-cap: "Filter vs Smoothing Estimates"
#| fig-width: 12
#| fig-height: 4
